...
- [x] 5.8.1 **IMPL**: 色テーマの最終調整
  ...
  - ホバー効果追加 (10% lighter)
  - アクティブ時のハイライト
- [x] **5.8.1.1 視認性改善** (2025-01-14追加):
  - **スライダートラック**: 50,50,50 (背景より暗く、境界明確化)
  - **スライダーハンドル**: 255,255,255 (白・高コントラスト、位置明確化)
  - **スライダーフレーム**: 40,40,40 (より暗い枠線)
  - **ノブ**: 120,120,120 (背景80,80,80より明るく、視認性確保)
...
- [ ] **5.8.8 視認性検証** (2025-01-14追加):
  - [ ] スライダートラック領域が背景と明確に区別できる
  - [ ] スライダーハンドルが明確に見える
  - [ ] ノブが背景と明確に区別できる
  - [ ] 暗い環境でも全コントロールが視認可能
